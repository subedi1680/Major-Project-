                                ...
                                <div className="mt-3 space-y-2">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-1 text-xs">
                                        <div className={`flex items-center gap-2 ${
                                            passwordStrength.hasMinLength ? 'text-green-400' : 'text-slate-400'
                                        }`}>
                                        ...
                                        <div className={`flex items-center gap-2 ${
                                            passwordStrength.hasUppercase ? 'text-green-400' : 'text-slate-400'
                                        }`}>
                                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div className={`flex items-center gap-2 ${
                                            passwordStrength.hasNumber ? 'text-green-400' : 'text-slate-400'
                                        }`}>
                                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div className={`flex items-center gap-2 ${
                                            passwordStrength.hasSymbol ? 'text-green-400' : 'text-slate-400'
                                        }`}>
                                            <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
