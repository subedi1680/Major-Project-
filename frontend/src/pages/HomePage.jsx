      ...
      <div className="relative max-w-7xl mx-auto text-center animate-fade-in">
        <div className="mb-8">
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-slate-300 mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            your skills and aspirations through
...
function Features() {
  const features = [
    ...
    },
    {
      ...
      description:
        "All job postings are verified to ensure authenticity and quality opportunities.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16 lg:mb-20 animate-fade-in">
          ...
          <p className="text-lg lg:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
            We make job searching simple, efficient, and successful for both job
