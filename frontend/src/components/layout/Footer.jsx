      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-1 lg:col-span-2">
            <h3 className="text-3xl lg:text-4xl font-bold mb-6 gradient-text">JobBridge</h3>
          ...
          {/* Job Seekers Links */}
          <div>
            <h4 className="text-xl font-bold mb-6 text-slate-100">For Job Seekers</h4>
            <ul className="space-y-4 text-slate-300">
              <li>
                <a href="#" className="hover:text-primary-400 transition-colors font-medium">
                  Browse Jobs
                </a>
              </li>
              <li>
          ...
          {/* Employers Links */}
          <div>
            <h4 className="text-xl font-bold mb-6 text-slate-100">For Employers</h4>
            <ul className="space-y-4 text-slate-300">
              <li>
                <a href="#" className="hover:text-primary-400 transition-colors font-medium">
                  Post Jobs
